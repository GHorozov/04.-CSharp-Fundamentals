namespace RecyclingStation.WasteDisposal
{
    ...
    public class StrategyHolder : IStrategyHolder
    {
        ...
        {
            if (!this.strategies.ContainsKey(disposableAttribute)) //Id this attribute is not in dict add to it
            {
        ...
        {
            if (this.strategies.ContainsKey(disposableAttribute)) //If this dict contains attribute remove it. 
            {
