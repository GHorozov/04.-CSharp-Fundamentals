namespace _06.CarSalesman
{
    ...
    class StartUp
    {
        ...
        private static void CollectCars(List<Car> cars, List<Engine> engines)
        {
        ...
        private static void CollectEngines(List<Engine> engines)
        {
            string[] parameters = Console.ReadLine().Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
            string model = parameters[0];
